...
{% include advisory-card.html avatarurl="martyna.jpg" profilename="Martyna Łempicka, MSc" affiliation="<br> Graduate of the Faculty of Physics,<br> University of Warsaw" linkedin="mlempicka" git='' <br>Warsaw, Poland"%}
