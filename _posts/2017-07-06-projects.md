...
<a href="{{ url }}index.html#project1"> Project 1: Mentally Disordered Agents </a> **FULL**
...
<a href="{{ url }}index.html#project6">Project 6: Reduction of Psychiatric Multimorbidity in a Large Pediatric Sample using EEG and MRI</a> **FULL**

<a href="{{ url }}index.html#project7">Project 7: Validating quantitative susceptibility mapping (QSM) at 3T and 9.4T</a> **FULL**
...
<a href="{{ url }}index.html#project9">Project 9: Enhancing SSVEP detection with frequency hopping</a> **FULL**
...
1. Conversational English with ease of reading scientific papers.
2. Reinforcement Learning Basics (preferred)
3. Experience with some deep learning framework (Keras, Tensorflow, PyTorch)
4. Linear Algebra
...
3. Coding Skills
4. Insight into mental disorders

**A list of 1-5 key papers / online materials summarising the subject:**

1. Adams, R. A., Huys, Q. J. M., & Roiser, J. P. (2016). Computational Psychiatry: Towards a mathematically informed understanding of mental illness. Journal of Neurology, Neurosurgery and Psychiatry, 87(1), 53–63. [https://doi.org/10.1136/jnnp-2015-310737](https://doi.org/10.1136/jnnp-2015-310737)
2. Dayan, P. (2009). Dopamine, Reinforcement Learning, and Addiction.
3. Redish, A. D., Jensen, S., & Johnson, A. (2008). A unified framework for addiction: Vulnerabilities in the decision process. Behavioral and Brain Sciences, 31(4), 415–487. [https://doi.org/10.1017/S0140525X0800472X](https://doi.org/10.1017/S0140525X0800472X)
4. Sharp, P. B., & Eldar, E. (2019). Computational Models of Anxiety: Nascent Efforts and Future Directions. Current Directions in Psychological Science, 28(2), 170–176. [https://doi.org/10.1177/0963721418818441](https://doi.org/10.1177/0963721418818441)
5. Mkrtchian, A., Aylward, J., Dayan, P., Roiser, J. P., & Robinson, O. J. (2017). Modeling Avoidance in Mood and Anxiety Disorders Using Reinforcement Learning. Biological Psychiatry, 82(7), 532–539. [https://doi.org/10.1016/j.biopsych.2017.01.017](https://doi.org/10.1016/j.biopsych.2017.01.017)
...
![test image size]({{ site.url }}/img/projects/project2.png?style=centerme){:class="img-responsive" height="80%" width="80%" align="center"}
...
1. Basic understanding of experimental approaches in auditory neuroscience
2. Experimental and analysis flow of multi-unit extracellular recordings
3. Hands on session with data analysis
4. Testing their own hypothesis
5. If you are a beginner in electrophysiology data analysis you will learn how to handle data to represent basic neural response’s parameters. If you have already experience, you can discover totally new facts about sounds processing in mouse auditory cortex. 
...
## Project 3: Game controlled by SSVEP paradigm using Blinker device [https://braintech.pl/blinker](https://braintech.pl/blinker)
...
1. Hands on experience of real-time analysis of EEG signals 
2. Assistive technology design 
3. BCI Design

**A list of 1-5 key papers / online materials summarising the subject:**

1. [https://braintech.pl/bci/?lang=en](https://braintech.pl/bci/?lang=en)
2. [https://braintech.pl/bci/?lang=en#bci-ssvep](https://braintech.pl/bci/?lang=en#bci-ssvep)
...
5. [http://scikit-learn.org/stable/modules/linear_model.html#lasso](http://scikit-learn.org/stable/modules/linear_model.html#lasso)
...
2. Where they are insightful or misleading.

The project will have three main parts (you may take part in one, two or all of these activities):
1. Writing interactive stories with concrete examples
2. Designing data visualizations
3. Developing a Vue.js application

As a result, we want to extend a project "Which ML are you?" [https://github.com/stared/which-ml-are-you](https://github.com/stared/which-ml-are-you) which can be a powerful tool for learning how to use and interpret common information retrieval metrics.

![test image size]({{ site.url }}/img/projects/piotrek.png?style=centerme){:class="img-responsive" height="80%" width="80%" align="center"}
...
1. Develop a small Vue.js application with a visualization of a ROC curve,
...
If you decided to apply for this project please consider that you are asked to make one of the proposed problems. Along with the registration through our form, please prepare the given application and send this solution to your potential project leaders at: **pmigdal@gmail.com** <br>
Your email communication should then consist of:
1. Your solution to one of the problems
2. Information about which place on your desired project list this project has (is it your first or for example second choice)

**A list of 1-5 key papers / online materials summarising the subject:**

1. Tom Fawcett, An introduction to ROC analysis, [https://people.inf.elte.hu/kiss/13dwhdm/roc.pdf](https://people.inf.elte.hu/kiss/13dwhdm/roc.pdf)
2. Problem explanation: [https://victorzhou.com/blog/intro-to-random-forests/](https://victorzhou.com/blog/intro-to-random-forests/)
3. Understanding ROC curves: [http://arogozhnikov.github.io/2015/10/05/roc-curve.html](http://arogozhnikov.github.io/2015/10/05/roc-curve.html)
4. Visualization inspiration: [http://www.r2d3.us/visual-intro-to-machine-learning-part-1/](http://www.r2d3.us/visual-intro-to-machine-learning-part-1/)
5. More examples: [https://explorabl.es/](https://explorabl.es/)
...
What can we do?
1. Train some interesting models (medical, financial, legal, including biases, etc.)
2. Create a dialogue system as an interface for the model
3. Work on explaining model decisions
4. Find interesting questions to be asked for the model
5. Anything that comes to your mind and we might do using chatbot as an interface for the Machine Learning model (any ideas are welcome)

![test image size]({{ site.url }}/img/projects/project5.png?style=centerme){:class="img-responsive" height="80%" width="80%" align="center"}
...
1. English: good
2. The ability to train a simple Machine Learning model will be helpful.
...
1. Book about interpretable ML [https://christophm.github.io/interpretable-ml-book/](https://christophm.github.io/interpretable-ml-book/)
2. Poster summarizing a project in that area [https://github.com/kmichael08/kmichael08.github.io/blob/master/XAIbot___poster-v1.pdf](https://github.com/kmichael08/kmichael08.github.io/blob/master/XAIbot___poster-v1.pdf)
3. Link to an existing chatbot [https://kmichael08.github.io/](https://kmichael08.github.io/)
4. [https://arxiv.org/abs/1706.07269](https://arxiv.org/abs/1706.07269)
...
1. Knowledge in neuroscience and psychology
2. Practice in data science and statistics

**What participants gain/learn from this project:**

1. Identifying biomarkers for psychiatry
2. Learning about limitations of neuroanatomical and neurophysiological measures in psychiatry
...
![test image size]({{ site.url }}/img/projects/project7.png?style=centerme){:class="img-responsive" height="80%" width="80%" align="center"}
...
3. [https://en.wikipedia.org/wiki/Quantitative_susceptibility_mapping](https://en.wikipedia.org/wiki/Quantitative_susceptibility_mapping)
...
2. Ability to do basic data transformations in python (pandas)
3. Some experience in Machine Learning (NLP, classical ML algorithms such as regression, - random forest, basic understanding of NN)
4. Programming skills in Python, Tensorflow or PyTorch
...
3. Dlated interpersonal biases. Journal of Experimental Social Psychology 3, Vol. 49, Issue 3, 349-354 (2013) DOI:10.1016/j.jesp.2012.12.007 3) [https://en.wikipedia.org/wiki/FiveThirtyEight](https://en.wikipedia.org/wiki/FiveThirtyEight)
...
1. [https://ieeexplore.ieee.org/abstract/document/726253](https://ieeexplore.ieee.org/abstract/document/726253)
2. [http://yadda.icm.edu.pl/yadda/element/bwmeta1.element.baztech-ec940f00-2f27-45b1-8569-3b8304261353](http://yadda.icm.edu.pl/yadda/element/bwmeta1.element.baztech-ec940f00-2f27-45b1-8569-3b8304261353)
