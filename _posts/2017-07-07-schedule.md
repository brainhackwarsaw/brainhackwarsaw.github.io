...
<p lang="en-US"><span lang="en-US">Talk from: Guillaume Dumas</span></p>
...
<p lang="en-US"><span lang="en-US">Ignite talk: Nicolas Langer</span></p>
</td>
<td bgcolor="{{  hacking1  }}" width="127">
</td>
<td bgcolor="{{  dinner  }}" width="119">
...
<td bgcolor="{{  lecture  }}" width="118">
<p lang="en-US"><span lang="en-US"><em><a href="{{ url }}index.html#langer">The Endeavour for Biomarker Research</a></em>
</span></p>
</td>
<td bgcolor="{{ hacking2 }}" width="127">
<p lang="en-US"><span lang="en-US">Brain hacking</span></p>
